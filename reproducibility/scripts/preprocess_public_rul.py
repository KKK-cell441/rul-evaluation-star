# -*- coding: utf-8 -*-
"""Full preprocessing for PHM2012 and IMS into dbca-net processed format."""
...
ROOT_DATA = ROOT_FW / "data" / "raw"
PROCESSED = ROOT_FW / "data" / "processed"
sys.path.insert(0, str(ROOT_1111))

from data.preprocessing import extract_features_from_window  # noqa: E402
from utils.rul_labels import make_rul_labels  # noqa: E402
