...
PACKAGE_ROOT = Path(__file__).resolve().parent / "rul_package"
sys.path.insert(0, str(Path(__file__).resolve().parent))

from rul_package.data.dataset import BearingRULDataset  # noqa: E402
from rul_package.utils.metrics import compute_metrics  # noqa: E402
...
_tcn_mod = _load_module("tcn_model", PACKAGE_ROOT / "models" / "tcn_model.py")
_patch_mod = _load_module("patchtst_model", PACKAGE_ROOT / "models" / "patchtst_model.py")
