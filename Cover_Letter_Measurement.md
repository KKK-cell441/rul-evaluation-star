...
This manuscript addresses an under-examined methodological issue: whether reported bearing remaining useful life (RUL) improvements reflect model capability or evaluation design. We investigate how evaluation protocols define reliability estimates and whether benchmark scores support deployment-oriented model selection. The paper does not propose a new diagnostic network. Instead, it evaluates the combined effects of label construction and temporal splitting under a controlled protocol comparison. The contribution is to establish reproducible evaluation protocols and improve comparability across bearing RUL studies, not to critique specific published results.
